...
package lib.badge.com.badgeviewlib;
...
public class BadgeView extends TextView {
    ...
    private void init() {
        ...
        setPadding(dip2Px(5), dip2Px(0), dip2Px(5), dip2Px(0));
    ...
    public boolean ismShowPoint()
    {
        return mShowPoint;
    }

    public void setmShowPoint(boolean mShowPoint)
    {
        this.mShowPoint = mShowPoint;
    }
    ...
    public void setText(CharSequence text, BufferType type) {
        if (isHideOnNull() && (text == null || text.toString().equalsIgnoreCase("0") || text.toString().equals(""))) {
            if(ismShowPoint())
            {
    ...
    /**
     * if count is 0 show Dot
     */
    private boolean setIconLayoutParam(int count)
    {
        if(count == 0)
        {
            setText("");
            ViewGroup.LayoutParams layoutParams = getLayoutParams();
            layoutParams.width = dip2Px(15);
            layoutParams.height = dip2Px(15);
            setLayoutParams(layoutParams);
            setPadding(dip2Px(0), dip2Px(0), dip2Px(0), dip2Px(0));
            return true;
        }
        else
        {
